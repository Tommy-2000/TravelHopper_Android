...
public class MyGalleryRecyclerViewAdapter extends RecyclerView.Adapter<MyGalleryRecyclerViewAdapter.MyGalleryViewHolder> {
    ...
    private final ArrayList<Uri> galleryMediaList;

    public MyGalleryRecyclerViewAdapter(ArrayList<Uri> galleryMediaList) {
    ...
    public static class MyGalleryViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyGalleryViewHolder(MediaCardViewBinding binding) {
            super(binding.getRoot());
            mediaImageView = binding.materialCardFrame;
        }
    }
...
//        myGalleryViewHolder.mediaImageView.setImageURI(galleryMediaList.get(position));
        ...
        Glide.with(myGalleryViewHolder.mediaImageView.getContext()).load(galleryMediaList.get(position)).skipMemoryCache(true).apply(RequestOptions.circleCropTransform()).into(bindingMediaCardView.materialCardFrame);
...
//        setRecyclerViewAnimation(myGalleryViewHolder.mediaFrameUri, position);
    }
